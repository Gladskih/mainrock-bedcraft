...
export type RaknetBackend = "raknet-native" | "jsp-raknet" | "raknet-node";
...
export const RAKNET_BACKEND_JS: RaknetBackend = "jsp-raknet"; // JS RakNet backend (UDP/IPv4) without native build tooling.
export const DEFAULT_RAKNET_BACKEND: RaknetBackend = RAKNET_BACKEND_JS; // Prefer JS RakNet to avoid native build tooling by default.
